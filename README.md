...
**I almost clicked Apply.**

Instead, I spent my Wednesday afternoon building this.

Not because I thought it would guarantee an interview.

Because your job description genuinely excited me.

Somewhere between teaching an AI coding assistant engineering standards,
documenting AI workflows, and accidentally turning a private Minecraft server
into a real engineering platform...

...I realized we were thinking about many of the same problems.

So instead of telling you why I'd be a good fit, I built something.
